...
#Housekeeping code:- initialze vectors of power and type II error rates
power.vector <- NULL
beta.vector <- NULL


#Determine the critical value of the F-distribution under Ho: no differences
...
#Create an informative table with the information we need:
